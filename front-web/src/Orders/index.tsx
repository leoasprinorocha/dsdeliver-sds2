...
function Orders() {
    ...
    useEffect(
        () => {
           fetchProducts().then(response => setProducts(response.data)).catch(error => console.log('Erro no sistema')); 
        },
    [])
  ...
  return (
    ...
    <StepsHeader/>
    <ProductsList products={products} onSelectedProduct={handleSelectProduct} 
